...
_C.ASP_RATIOS = [1.3, 1.3, 1.3, 1.3, 1.3, 1.3]
_C.CLIP = False
_C.VARIANCE = [0.1, 0.2]
...
# dataset config
_C.HOME = '/home/caoleilei/work'

# face config
_C.FACE = EasyDict()
_C.FACE.TRAIN_FILE = './data/face_train.txt'
_C.FACE.VAL_FILE = './data/face_val.txt'
_C.FACE.WIDER_DIR = '/home/caoleilei/work/data/widerface'
_C.FACE.FDDB_DIR = '/home/caoleilei/work/data/FDDB'
_C.FACE.UFDD='/home/caoleilei/data/work/UFDD'
