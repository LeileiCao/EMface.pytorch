...
class FPN(nn.Module):
    def __init__(self):
        ...
        self.toplayer1 = ModulatedDeformConvPack(256, 256, kernel_size=(3,3), stride=1, padding=1, deformable_groups=1)
        self.toplayer2 = ModulatedDeformConvPack(256, 256, kernel_size=(3,3), stride=1, padding=1, deformable_groups=1)
        self.toplayer3 = ModulatedDeformConvPack(256, 256, kernel_size=(3,3), stride=1, padding=1, deformable_groups=1)
...
class S3FD(nn.Module):
    ...
    def __init__(self, phase, base_model, head, num_classes=2):
        ...
        self.layer6 = ModulatedDeformConvPack(256, 256, kernel_size=(3,3), stride=2, padding=1, deformable_groups=1)                                
        self.layer7 = ModulatedDeformConvPack(256, 256, kernel_size=(3,3), stride=2, padding=1, deformable_groups=1)
        self.fpn=FPN()
        self.MR1=RFP(256)
        self.MR2=RFP(256)
        self.MR3=RFP(256)
